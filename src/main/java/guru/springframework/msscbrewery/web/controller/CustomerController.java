...
public class CustomerController {
    ...
    @PostMapping
    public ResponseEntity<HttpHeaders> create(@RequestBody CustomerDto customerDto) {
    ...
    public ResponseEntity<HttpStatus> update(@PathVariable("customerId") UUID customerId, @RequestBody CustomerDto customerDto) {
